...
/**
 * A card that sticks to the top of the viewport and stacks with other StickyCards.
 * It scales down slightly as subsequent cards scroll over it.
 */
export function StickyCard({
  ...
  // When this card hits the top, scale it down slightly as we keep scrolling
  ...
  return (
    <motion.div
      ref={cardRef}
      className={cn("sticky", className, topPosition)}
      style={{
        top: topPosition,
